...
use App\Exports\AccessoryReportExport;
use App\Exports\ActivityReportExport;
use App\Exports\AssetMaintenanceReportExport;
use App\Exports\CustomReportExport;
use App\Exports\LicenseReportExport;
use App\Exports\UnacceptedReportExport;
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('reports/assets/maintenance/export', function(Request $request){
        return Excel::download(new AssetMaintenanceReportExport(), 'bao-cao-tai-san-bao-tri.xlsx');
    })->name('asset_maintenances.export');
    Route::get(
        'reports/licenses',
    ...
    Route::get('reports/licenses/export', function(Request $request){
        return Excel::download(new LicenseReportExport(), 'bao-cao-ban-quyen.xlsx');
    ...
    Route::get('reports/accessories/export', function(Request $request){
        return Excel::download(new AccessoryReportExport(), 'bao-cao-phu-kien.xlsx');
    })->name('accessories.export');
    ...
    Route::get('reports/custom/export', function(Request $request){
        // dd($request->all());
       return Excel::download(new CustomReportExport(), 'bao-cao-tai-san.xlsx');
    })->name('custom.export');
    ...
    Route::get('reports/activity/export', function(Request $request){
        return Excel::download(new ActivityReportExport(), 'bao-cao-hoat-dong.xlsx');
    })->name('log.export');
    ...
    Route::get('reports/unaccepted_assets/{deleted?}/export', function(Request $request){
         return Excel::download(new UnacceptedReportExport(), 'bao-cao-tai-san-chua-duoc-chap-nhap.xlsx');
    })->name('unaccepted_assets.export');
