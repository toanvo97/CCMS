...
@section('header_right')
    ...
    <form id="formSubmitExport" method="get" action="{{route('asset_maintenances.export')}}">
        @csrf
        <select id="asset_maintenances_export" name="export_type" class="btn btn-default">
...
@section('moar_scripts')
  <script>
    $(document).on('click', '#asset_maintenances_export', function(){
      if($(this).val() != ''){
