    ...
    <div class="btn-toolbar" role="toolbar">
        <div class="btn-group mr-2" role="group">
            @if($showDeleted)
                ...
                <form id="formSubmitExport" method="get" action="{{route('unaccepted_assets.export', ['deleted' => 'deleted'])}}">
                  <input type="text" name="deleted" value="deleted" hidden>
            @else
                ...
                <form id="formSubmitExport" method="get" action="{{route('unaccepted_assets.export', ['deleted' => 'not-deleted'])}}">
                  <input type="text" name="deleted" value="not-deleted" hidden>
            @endif
              @csrf
              <select id="unaccepted_asset_export" name="export_type" class="btn btn-default">
...
@section('moar_scripts')
  <script>
    $(document).on('click', '#unaccepted_asset_export', function(){
      if($(this).val() != ''){
