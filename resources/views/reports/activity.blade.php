...
@section('header_right')
    ...
    <form id="formSubmitExport" method="get" action="{{route('log.export')}}">
        @csrf
        <select id="activity_export" name="export_type" class="btn btn-default">
...
<script>
    $(document).on('click', '#activity_export', function(){
        if($(this).val() != ''){
