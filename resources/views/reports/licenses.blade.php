...
@section('header_right')
    ...
    <form id="formSubmitExport" method="get" action="{{route('licenses.export')}}">
        @csrf
        <select id="licenses_export" name="export_type" class="btn btn-default">
...
@section('moar_scripts')
    <script>
        $(document).on('click', '#licenses_export', function(){
            if($(this).val() != ''){
