                        ...
                        <div class="form-group {{ $errors->has('site_name') ? 'error' : '' }}">
                            ...
                            <div class="col-md-7 required">
                                @if (config('app.lock_passwords')===true)
                                    {{ Form::text('site_name', Request::old('site_name', $setting->site_name), array('class' => 'form-control', 'disabled'=>'disabled','placeholder' => 'Okuro-IT Asset Management')) }}
                                    <p class="text-warning"><i class="fas fa-lock"></i> {{ trans('general.feature_disabled') }}</p>
                                @else
                                    {{ Form::text('site_name',
                                        Request::old('site_name', $setting->site_name), array('class' => 'form-control','placeholder' => 'Okuro-IT Asset Management', 'data-validation' => 'required')) }}
                                @endif
