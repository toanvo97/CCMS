...
return [
    ...
    'ldap_activated_flag_help'  => 'Cờ này được sử dụng để xác định xem người dùng có thể đăng nhập vào Okuro-IT hay không và không ảnh hưởng đến khả năng kiểm tra các mục vào hoặc chuyển ra của họ.',
    ...
    'load_remote_help_text'		=> 'Cài đặt Okuro-IT này có thể tải các tập lệnh từ thế giới bên ngoài.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Nếu một liên kết url được cung cấp ở đây, người dùng sẽ được chuyển hướng đến liên kết URL này sau khi người dùng đăng xuất khỏi Okuro-IT. Điều này hữu ích để đóng các phiên người dùng của nhà cung cấp Xác thực bạn một cách chính xác.',
    ...
    'show_images_in_email_help'   => 'Bỏ chọn hộp này nếu cài đặt Okuro-IT của bạn nằm sau VPN hoặc mạng riêng tư và người dùng bên ngoài mạng sẽ không thể tải hình ảnh được cung cấp từ cài đặt này trong email của họ.',
    ...
    'snipe_version'  			=> 'Phiên bản Okuro-IT',
    'support_footer'            => 'Hỗ trợ liên kết ở chân trang ',
    'support_footer_help'       => 'Chỉ định ai nhìn thấy các liên kết đến Thông tin người dùng và Hướng dẫn sử dụng Okuro-IT',
    'version_footer'            => 'Hiển thị phiên bản ở cuối trang ',
    'version_footer_help'       => 'Chỉ định ai xem phiên bản Okuro-IT và số bản dựng.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Liên kết đến Okuro-IT trong email',
    'show_url_in_emails_help_text'      => 'Bỏ chọn hộp này nếu bạn không muốn liên kết lại với cài đặt Okuro-IT của mình trong phần chân trang email. Có ích nếu hầu hết người dùng của bạn không đăng nhập.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'This will attempt to delete cached barcodes. This would typically only be used if your barcode settings have changed, or if your Okuro-IT URL has changed. Barcodes will be re-generated when accessed next.',
